        ...
        <div className="relative min-h-screen w-full overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-2 max-[1163px]:grid-cols-1 min-h-screen mx-15 max-[520px]:mx-5">
                ...
                <div className="flex absolute max-[1163px]:hidden max-[1300px]:-left-17 -left-10 bottom-28 flex-col mt-auto">
                    <div>
                        <h2 className="text-center text-white font-bold text-3xl">من الفكرة الى الاستثمار</h2>
                        <p className="text-center text-white text-sm font-semibold pt-3">منصة ذكية تربط أصحاب الأفكار بالمستثمرين، بتقييم موضوعي<br /> يكشف القيمة الحقيقية لكل مشروع</p>
                    </div>
