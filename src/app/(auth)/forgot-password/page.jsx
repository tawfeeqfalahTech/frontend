            ...
            <div className="relative z-10 grid grid-cols-2 max-[1155px]:grid-cols-1 min-h-screen mx-15 max-[520px]:mx-5">
                <div className="flex items-center max-[1155px]:justify-center h-screen max-[520px]:my-10">
                    <div className="bg-white rounded-2xl w-full max-w-100 px-6 pb-5 pt-8">
                        ...
                        <Link href="/login" className="text-sm text-center font-bold mt-4 flex justify-center items-center gap-1 group text-gray-600 hover:text-black transition-colors duration-200">العودة لتسجيل الدخول <ArrowLeftIcon size={20} className="group-hover:-translate-x-1 transition-transform duration-200" /></Link>
                    </div>
                </div>
